...
*                     pages. This program requires the V3240PA.ASM    *
...
begin
 ...
 GrfxPrint( 46, MAXY-10, 15, 255, 'V3240P  -  (c) by Michael Tischer');

 setpage( 1 );                                       { Process page 1 }
 ...
 for page := 0 to 50 do                               { 50 executions }
   begin
     showpage( page mod 2 );                           { Display page }
...
begin
 if IsVga then                                  { VGA card installed? }
   ...
   writeln( 'V3240P  -  (c) 1992 by Michael Tischer'#13#10#10 +
